...
import ChallanBillMain from "../../components/pageComponent/ChallanBillMain";



function ChallanBillModal() {
    ...
    <div className="modal-button">
      ...
      >
        <ModalHeader toggle={toggleModal} >
         <span className="modal_header">Challan Bill</span>
...
export default ChallanBillModal;
