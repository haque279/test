...
import SalaryPackageMain from "../../components/pageComponent/SalaryPackageMain";
import SalaryPackage from "../../components/pageComponent/SalaryPackage";
// import {} from "../../../src/assets/scss/"

function SalaryPackageModal() {
    ...
    <div className="modal-button">
      ...
      >
        <ModalHeader className="modalHeader" toggle={toggleModal}>
          ...
          <span className="modal_header" >Salary Package</span>
          <Button
