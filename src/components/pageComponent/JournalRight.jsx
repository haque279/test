...
const JournalLeft = ({ getRightData,emptyArray }) => {
  ...
  const addRows = (e) => {
    ...
    if (price && value) {
      ...
      getRightData(entry, total + newTotal);
  ...
  return (
    <Col>
      <h3 className="primary">
        Credit
        <span className="journal-total">Total Credit: TK {total}</span>
      </h3>
      {error ? (
