...
const ReturnChallanRow = ({ item, stateChange, changeDelete }) => {
  ...
  const { returnChallan, update, remove } = useContext(ReturnChallanContext);
  ...
  const getInit = () => {
    let myItem = returnChallan.cart.filter((e) => e.id === item.id);
...
export default ReturnChallanRow;
