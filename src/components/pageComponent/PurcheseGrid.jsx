...
import ChallanModal from "../../views/partial/ChallanModalTest";
import PurchaseModal from "../../views/partial/PurchaseModal";
...
const PurcheseGrid = () => {
  ...
  return (
    <>
      <PurchaseModal resetAddedList={resetAddedList} />

      <Card>
        <CardBody>
          <Row>
            <Col md={3}>
              <h2 className="primary">Purchase</h2>
            </Col>
            <Col>
              <h5>Invoice No</h5>
