...
import PhysicalStockMain from "../../components/pageComponent/PhysicalStockMain";
// import {} from "../../../src/assets/scss/"

function PhysicalStockModal() {
    ...
    <div className="modal-button">
      ...
      >
        <ModalHeader className="modalHeader" toggle={toggleModal}>
          <span className="modal_header" >Physical Stock</span>
...
export default PhysicalStockModal;
