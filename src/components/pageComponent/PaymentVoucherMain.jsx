...
import VoucherParticularPayment from "./VoucherParticularPayment";
...
const PaymentVoucherMain = () => {
  ...
  const getCashBank = async () => {
    try {
      ...
      console.log("bank cash", data.data);
    } catch (error) {
      console.log(error);
    }
  };
...
export default PaymentVoucherMain;
