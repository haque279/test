...
import ReturnChallanModal from "../../views/partial/ReturnChallanModal";

const ReturnChallanGrid = () => {
  ...
  const {
    ...
    getDate,
    getStoredParty,
  } = useContext(ReturnChallanContext);
  ...
  const handleAdd = (item) => {
    ...
    // console.log("my check entry", checkEntry);

    // if (resetList) {
    //   setCheckEntry([]);
    // } else {
    //   console.log("not", resetList);
    // }
  ...
  return (
    <>
      <ReturnChallanModal resetAddedList={resetAddedList} />
      ...
      <Card>
        ...
        <CardBody>
          <Row>
            <Col md={3}>
              <h2 className="primary">Challan Page</h2>
            </Col>
            <Col>
              <h5>Invoice No</h5>
...
export default ReturnChallanGrid;
