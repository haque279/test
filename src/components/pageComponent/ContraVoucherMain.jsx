...
const ContraVoucherMain = () => {
  ...
  const particularData = (data) => {
    ...
    if (
      depositWithdraw.label === "Deposit" ||
      depositWithdraw.label === "Withdraw"
    ) {
      if (balanceType === "Dr") {
      ...
      <Card>
        <CardBody>
          ...
          <div style={{ textAlign: "right" }}>
            <span className="journal-total3">Total Amount: TK {newTotal} </span>
          </div>
          <Form>
            <Row>
              <Col>
                ...
                <Select
                  ...
                  defaultValue={dropDataDeposit[0]}
                  name="color"
                  options={dropDataDeposit}
                  value={depositWithdraw}
                  onChange={(e) => {
                    setDepositWithdraw({ label: e.label, value: e.value });
                  }}
                />
              </Col>
              <Col>
            ...
            <VoucherParticular
              ...
              particularUrl={`${BASE.URL}/api/ddldata/DDLBankLedger`}
...
export default ContraVoucherMain;
